...
const FilterProductionTableModal: React.FC<Props> = ({
  ...
  const status: OptionType[] = [
    ...
    { label: "Testing Pending", value: "Testing" },
    { label: "Repair Pending", value: "Repair Pending" },
    { label: "Cancelled", value: "Cancelled" },
  ];
  const type: OptionType[] = [
    { label: "All Processes", value: "all" },
    { label: "Master Process", value: "Master Process" },
  ];
        ...
        <div className="">
          ...
          <div className="px-6 py-4 space-y-5">
            <div className="flex gap-5 items-center">
              <div className="text-sm text-nowrap ml-0.5">Process Stage</div>
            ...
            <div className="flex gap-5 items-center">
              <div className="text-sm text-nowrap ml-0.5">Type</div>
              <div className="w-full flex justify-end">
                <div className="w-full max-w-56">
                  <SelectFilter
                    items={type}
