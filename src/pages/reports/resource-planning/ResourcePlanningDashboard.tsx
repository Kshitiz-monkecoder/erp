...
const ResourcePlanningCard: React.FC = () => {
  ...
  const handleGenerateResourcePlanning = async () => {
    try {
      let endpoint = "";
      let payload: any = {};
      ...
      ErrorToast({
        title: "Failed to generate Resource Planning",
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <h1 className="text-2xl font-semibold mb-6">Resource Planning</h1>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white w-full max-w-2xl rounded-2xl shadow-2xl p-8 z-10 animate-fadeIn">
            ...
            <h2 className="text-2xl font-semibold mb-2">
              Generate {selectedCard} Resource Planning
            </h2>

            <p className="text-gray-500 mb-6">
              Select filters and generate Resource Planning
            </p>
            ...
            <div className="flex justify-end gap-4">
              ...
              <button
                onClick={handleGenerateResourcePlanning}
...
export default ResourcePlanningCard;