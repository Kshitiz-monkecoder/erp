...
const mockData = [
  { date: "15 Dec", Inventory: 5, inwards: 4.5, qc: 15 },
  { date: "22 Dec", Inventory: 6, inwards: 5, qc: 2 },
  { date: "29 Dec", Inventory: 7.5, inwards: 6.5, qc: 3.5 },
  { date: "5 Jan", Inventory: 10, inwards: 9, qc: 6.5 },
  { date: "12 Jan", Inventory: 7.5, inwards: 7.5, qc: 6.5 },
  { date: "19 Jan", Inventory: 7, inwards: 6, qc: 5 },
  { date: "26 Jan", Inventory: 9, inwards: 9, qc: 8.5 },
  { date: "2 Feb", Inventory: 10, inwards: 9, qc: 8.5 },
  { date: "9 Feb", Inventory: 11, inwards: 10, qc: 7.5 },
  { date: "16 Feb", Inventory: 12.5, inwards: 11.5, qc: 10 },
  { date: "23 Feb", Inventory: 14, inwards: 12.5, qc: 12 },
  { date: "2 Mar", Inventory: 15, inwards: 15, qc: 15 },
];
...
function ChartLegend() {
  return (
    <div className="flex gap-6 mt-4">
      <LegendItem color="#2F855A" label="Inventory Orders" />
