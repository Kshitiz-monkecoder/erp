...
const mockData = [
  { date: "15 Dec", purchase: 5, inwards: 4.5, qc: 15 },
  { date: "22 Dec", purchase: 6, inwards: 5, qc: 2 },
  { date: "29 Dec", purchase: 7.5, inwards: 6.5, qc: 3.5 },
  { date: "5 Jan", purchase: 10, inwards: 9, qc: 6.5 },
  { date: "12 Jan", purchase: 7.5, inwards: 7.5, qc: 6.5 },
  { date: "19 Jan", purchase: 7, inwards: 6, qc: 5 },
  { date: "26 Jan", purchase: 9, inwards: 9, qc: 8.5 },
  { date: "2 Feb", purchase: 10, inwards: 9, qc: 8.5 },
  { date: "9 Feb", purchase: 11, inwards: 10, qc: 7.5 },
  { date: "16 Feb", purchase: 12.5, inwards: 11.5, qc: 10 },
  { date: "23 Feb", purchase: 14, inwards: 12.5, qc: 12 },
  { date: "2 Mar", purchase: 15, inwards: 15, qc: 15 },
];
...
function ChartLegend() {
  return (
    <div className="flex gap-6 mt-4">
      <LegendItem color="#2F855A" label="Purchase Orders" />
...
export default function PurchasePerformance() {
